...
{
    public class DeselectDot : Action
    {
        protected Dot _dot;
        ...
        public DeselectDot(Dots dots, PlayerType playerType, Dot dot, int tick) : base(dots, playerType, tick)
        {
            _dot = dot;
        }
        ...
        {
            return "[DeselectDot | " + PlayerType + " | " + _dot + " | Time: " + _tick + "]" ;
        }
