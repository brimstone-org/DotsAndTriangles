...
{
    public class PlayerStartTurn : Action
    {
        ...
        public PlayerStartTurn()
        {
        }

        public PlayerStartTurn(Dots dots, PlayerType playerType, int tick) : base(dots, playerType, tick)
        {
        }

        public override string ToString()
        {
            return "[PlayerStart | " + _playerType + " | Time: " + _tick + "]";
        }
